---
title: 사용량 추적
description: H Chat v4의 프로바이더별 토큰 사용량 추적, 비용 추정, 일별 차트, 예산 알림 및 90일 보존 정책 안내
badges: [v4]
---

# 사용량 추적

H Chat v4에서 더욱 강화된 사용량 추적 시스템은 AWS Bedrock, OpenAI, Google Gemini 각 프로바이더별로 토큰 사용량과 비용을 정밀하게 추적하고 상세한 분석을 제공합니다.
...
- **실시간 분석 대시보드**: 프로바이더/모델/기능별 실시간 통계
- **비용 최적화 제안**: AI 기반 사용 패턴 분석 및 개선 제안
- **예산 알림**: 설정한 예산 초과 시 알림
...
v4에서는 예산 관리 기능이 완전히 구현되어 설정한 예산을 초과하면 자동으로 알림을 받을 수 있습니다.
...
v4에서는 주간/월간 사용량 리포트를 자동으로 생성하고 대시보드에서 확인할 수 있습니다.
