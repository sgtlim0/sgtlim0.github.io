...
- **Storybook**: UI 컴포넌트 문서 및 카탈로그 (103개 스토리)
...
| Storybook | UI 컴포넌트 문서 (103개 스토리, 97% 커버리지) | https://hchat-wiki-storybook.vercel.app | 6006 |
...
### Storybook
- 모든 UI 컴포넌트의 인터랙티브 카탈로그 (103개 스토리, 97% UI 커버리지)
- 다크 모드 테마 toggle
- 접근성 검사 (WCAG 2.1 AA)
- 컴포넌트별 Props 문서
