---
title: 자주 묻는 질문 (FAQ)
description: H Chat v3에 대한 일반적인 질문과 답변
---
...
H Chat v3는 Chrome Extension Manifest V3 기반의 올인원 AI 어시스턴트입니다. 3가지 주요 AI 프로바이더(AWS Bedrock, OpenAI, Google Gemini)를 통해 총 9개의 AI 모델을 지원하며, 21가지 기능을 제공합니다.
...
H Chat v3는 AWS SDK를 사용하지 않고 SigV4 서명을 직접 구현하여 AWS Bedrock API와 통신합니다. 이를 통해:
...
H Chat v3는 실시간 웹 검색 결과를 AI 응답에 통합합니다:
...
네, H Chat v3는 프로바이더별 사용량을 자동으로 추적합니다:
...
H Chat v3 자체는 무료 오픈소스입니다. 비용은 사용한 AI 프로바이더의 API 요금에 따라 발생합니다:
...
H Chat v3는 Provider Factory 패턴을 사용하여 여러 AI 프로바이더를 통합 관리합니다:
